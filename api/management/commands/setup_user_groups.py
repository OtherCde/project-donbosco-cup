    ...
    def handle(self, *args, **options):
        if options["reset"]:
            ...
            Group.objects.filter(
                name__in=["CRUD_Users", "ReadOnly_Users", "Admin_Users"]
            ).delete()
        ...
        write_permissions = Permission.objects.filter(
            ...
            codename__in=[
                ...
                "change_tournament",
                "delete_tournament",
                "add_tournamentcategory",
                "change_tournamentcategory",
                "delete_tournamentcategory",
                "add_phase",
                "change_phase",
                "delete_phase",
                "add_round",
        ...
        self.stdout.write(
            f"✅ {all_permissions.count()} permisos asignados a CRUD_Users"
        )
        ...
        self.stdout.write(
            f"✅ {read_permissions.count()} permisos de lectura asignados a ReadOnly_Users"
        )
        ...
        self.stdout.write(
            f"✅ {admin_permissions.count()} permisos asignados a Admin_Users"
        )
        ...
        self.stdout.write(
            '  - Desde código: user.groups.add(Group.objects.get(name="CRUD_Users"))'
        )
