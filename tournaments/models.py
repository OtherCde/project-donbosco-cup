...
class TournamentCategory(models.Model):
    ...
    category_name = models.CharField(max_length=100, help_text="e.g., Class of 2019, Under-16")
...
class Phase(models.Model):
    ...
    tournament_category = models.ForeignKey(TournamentCategory, on_delete=models.CASCADE, related_name='phases')
    phase_name = models.CharField(max_length=100, help_text="e.g., League, Knockout, Group Stage")
...
class Round(models.Model):
    ...
    round_name = models.CharField(max_length=100, help_text="e.g., Matchday 1, Semifinal, Final")
