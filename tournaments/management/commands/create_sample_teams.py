...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        try:
            category = TournamentCategory.objects.get(id=options['tournament_category_id'])
            ...
            promotions_by_group = {
                ...
                "Grupo 4 (2008-2015)": ["2008", "2010", "2013", "2014", "2015A", "2015B"],
                "Grupo 5 (2017-2023)": ["2017", "2019", "2020A", "2020B", "2021", "2023"]
            }
            
            # Obtener promociones para este grupo
            group_name = category.category_name
            if group_name not in promotions_by_group:
                raise CommandError(f'No se encontraron promociones para el grupo: {group_name}')
