...
class Team(models.Model):
    tournament_category = models.ForeignKey(TournamentCategory, on_delete=models.CASCADE, related_name='teams')
...
class Player(models.Model):
    ...
    dni = models.CharField(
        max_length=8, 
        validators=[RegexValidator(regex=r'^\d{7,8}$', message='DNI must have 7 or 8 digits')]
    )
